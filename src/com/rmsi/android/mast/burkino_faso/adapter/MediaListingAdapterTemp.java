...
import com.rmsi.android.mast.burkino_faso.activity.Individual_ExistingListActivity;
	...
	public View getView(int position, View convertView, ViewGroup parent) 
	{
		...
		{			
			...
			public void onClick(View v) 
			{
				...
				{
					Individual_ExistingListActivity obj = (Individual_ExistingListActivity) activityObj;
					obj.showPopup(v, v.getTag());
				}
			}
		});
