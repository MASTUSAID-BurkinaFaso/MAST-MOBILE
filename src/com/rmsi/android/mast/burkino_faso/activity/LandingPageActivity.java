...
import com.rmsi.android.mast.burkino_faso.service.DownloadService;
import com.rmsi.android.mast.burkino_faso.service.UploadService;
import com.rmsi.android.mast.burkino_faso.util.CommonFunctions;
import com.rmsi.android.mast.burkino_faso.util.ServiceResultReceiver;
import com.rmsi.android.mast.burkino_faso.util.ServiceResultReceiver.Receiver;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		{			
			...
			public void onClick(View arg0) 
			{
				...
				AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
					alertDialogBuilder.setMessage(R.string.confirmation_sync);
					alertDialogBuilder.setTitle(R.string.syncdata);
